...
int main()
{
	...
	ft_printf("\033[33mca fait %-25p ans que je  travaille sur printf\n\033[0m", &testP);
	printf("ca fait %-25p ans que je  travaille sur printf\n", &testP);

	printf("\\\\\\\033[92mTEST p avec 2\033[0m///\n");
	ft_printf("\033[33mca fait %2p ans que je  travaille sur printf\n\033[0m", &testP);
	printf("ca fait %2p ans que je  travaille sur printf\n", &testP);

	printf("\\\\\\\033[92mTEST p avec d et 2\033[0m///\n");
	ft_printf("\033[33mca fait %2d ans que je  travaille sur printf\n\033[0m", 6589);
